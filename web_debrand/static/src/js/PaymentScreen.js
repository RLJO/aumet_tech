odoo.define('web_debrand.PaymentScreen', function (require) {
    'use strict';

    const { _t } = require('web.core');
    const PaymentScreen = require('pos_mercury.PaymentScreen');
                ...
                this.rpc(
                    ...
                    .then(function (data) {
                        ...
                        if (data === 'internal error') {
                            def.resolve({
                                message: self.env._t('Aumet Pharmacy Error while processing transaction.'),
                            });
                            return;
                        }
