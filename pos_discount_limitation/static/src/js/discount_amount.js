...
const FixedDiscountButton = require('pos_fixed_discounts.FixedDiscountButton');
const DiscountLimit = FixedDiscountButton =>
        class extends FixedDiscountButton {
        ...
        rpc.query({
            model: 'pos.config',
            method: 'check_user_limit_amount',
            args: [user, pc],
            })
...
Registries.Component.extend(FixedDiscountButton, DiscountLimit);
