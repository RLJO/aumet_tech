odoo.define('flexipharmacy.giftCardCreatePopupConform', function(require) {
    ...
    class giftCardCreatePopupConform extends AbstractAwaitablePopup {
        ...
        getConfirmPayload() {
            return {card_no: this.state.CardNumber, select_customer: this.state.SelectCustomer, text_expire_date: this.state.ExpireDate, text_amount: this.state.Amount, SelectCardType: this.state.SelectCardType, Paid: this.state.Paid,
            };
        }
        cancel() {
