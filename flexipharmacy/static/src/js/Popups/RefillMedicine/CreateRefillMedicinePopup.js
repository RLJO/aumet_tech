    ...
    class CreateRefillMedicinePopup extends AbstractAwaitablePopup {
        constructor() {
            ...
            this.state = useState({ 
                ...
                selectedCustomer: '',
                NoOfDays: 0,
                ExecutionDate: moment(new Date()).locale('en').format("DD/MM/YYYY"),
                DeliveryAddress: '',
                CustomerBlank: false,
        ...
        changeExecutionDate(event){
            this.state.ExecutionDate = moment(moment(new Date()).locale('en')).add(event, 'days').format("DD/MM/YYYY")
        }
        ...
        RefillMedicineLineData() {
            ...
            for (var i=0;i<=this.props.SelectedProductList.length;i++){
                ...
                if(this.props.SelectedProductList[i]){
                    ...
                    line['price'] = this.env.pos.db.thousandsDecimalChanger(price)
