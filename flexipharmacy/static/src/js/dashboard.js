odoo.define('aspl_pos_backend_dashboard.dashboard', function (require) {
    ...
    var POSDashboard = AbstractAction.extend({
        ...
        weekly_gross_salse : function(company_id){
            var self = this;
            var current_week_start_date = moment().locale('en').startOf('week').locale('en').format('YYYY-MM-DD');
            var current_week_end_date = moment().locale('en').endOf('week').locale('en').format('YYYY-MM-DD');
            var last_week_start_date = moment().locale('en').subtract(1, 'weeks').startOf('week').locale('en').format('YYYY-MM-DD');
            var last_week_end_date = moment().locale('en').subtract(1, 'weeks').endOf('week').locale('en').format('YYYY-MM-DD');
