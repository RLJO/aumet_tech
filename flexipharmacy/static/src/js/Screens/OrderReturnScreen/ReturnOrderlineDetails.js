odoo.define('flexipharmacy.ReturnOrderlineDetails', function (require) {
    'use strict';
     ...
     */
    class ReturnOrderlineDetails extends PosComponent {
        get line() {
    ...
    ReturnOrderlineDetails.template = 'ReturnOrderlineDetails';

    Registries.Component.add(ReturnOrderlineDetails);
