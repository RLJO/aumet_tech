...
var LinesWidget = Widget.extend({
    ...
    addProduct: function (lineDescription, model, doNotClearLineHighlight) {
        ...
        // console.log("sssss ", this.line_mapping_ids);
        // if (lineDescription.product_id.tracking === "none"){
        //     // this.trigger_up('save_line');
        //     // this.trigger_up('change_virtual_id', {line: $line, virtual_id: lineDescription.virtual_id});
        // }else{
        //     var id = $line.data('id');
        //     this.trigger_up('edit_line', {id: id});
        // }
        // If tracking , this.trigger_up('edit_line');
        // else , this.trigger_up('save_line');
