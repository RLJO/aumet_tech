...
class AccountMove(models.Model):
    ...
    patient_hi_percentage = fields.Float(related='partner_shipping_id.hi_percentage')
    patient_account_move_id = fields.Many2one('account.move', string='Patient Invoice', readonly=True, copy=False)
    insurance_account_move_id = fields.Many2one('account.move', string='Insurance Invoice', readonly=True, copy=False)
